<%-- 
    Document   : index
    Created on : Nov 1, 2016, 8:21:18 AM
    Author     : Admin
--%>
...
String trainingCenter = "";
  result = traininglogicl.createTraining(intTraininId, trainingDate, trainingTime, trainingCenter);
...
<script>
  ...
  %>
    ...
    <body>
        ...
        <div><label><a href="index.jsp">create</a></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><a href="viewTraining.jsp">view</a></label></div>
    <br> <br>
    <div id="container">
