 ...
 * @author Obute
 */
public abstract class SubjectBean implements EntityBean {
...
this.setSubjectId(key);
    ...
    public abstract Integer getSubjectId();

    public abstract void setSubjectId(Integer subjectId);
