 ...
 * @author Admin
 */
public abstract class TasktableBean implements EntityBean {
...
this.setTaskName(key);
    ...
    public abstract String getTeamMember();

    public abstract void setTeamMember(String teamMember);

    public abstract String getTaskStatus();

    public abstract void setTaskStatus(String taskStatus);

    public abstract String getTaskCreator();

    public abstract void setTaskCreator(String taskCreator);
