 ...
 * @author Admin
 */
public interface StudentinformationLocalHome extends EJBLocalHome {

    entitypackages.StudentinformationLocal findByPrimaryKey(java.lang.String key)  throws FinderException;
    
    entitypackages.StudentinformationLocal create(java.lang.String key)  throws CreateException;
