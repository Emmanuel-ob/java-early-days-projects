 ...
 * @author Obute
 */
public abstract class ComplainBean implements EntityBean {
    ...
    public abstract Integer getComplainId();

    public abstract void setComplainId(Integer complainId);
    ...
    public abstract String getDateReported();

    public abstract void setDateReported(String dateReported);

    public abstract String getDateResolved();

    public abstract void setDateResolved(String dateResolved);
    ...
    public abstract void setTicketStatus(String ticketStatus);
