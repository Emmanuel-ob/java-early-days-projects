 ...
 * @author Admin
 */
public class ServerrApp extends javax.swing.JFrame {

    /**
     * Creates new form ServerrApp
     */
    Socket sk;
    ...
    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
        try {
            ...
            Logger.getLogger(ServerrApp.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServerrApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServerrApp().setVisible(true);
            }
        });
    }
